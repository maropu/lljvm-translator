...
#include <jni.h>
/* Header for class org_maropu_lljvm_LLJVMNative */

#ifndef _Included_org_maropu_lljvm_LLJVMNative
#define _Included_org_maropu_lljvm_LLJVMNative
#ifdef __cplusplus
extern "C" {
#endif
/*
 * Class:     org_maropu_lljvm_LLJVMNative
 * Method:    magicNumber
